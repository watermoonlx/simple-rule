...
public class SerialRuleSetTest {
    ...
    public void testAndPass() {
        ...
        SerialRuleSet<String> ruleSet = new SerialRuleSet(rule1, rule2, rule3);
    ...
    public void testOrPass() {
        ...
        MockRule rule3 = new MockRule("A");
        SerialRuleSet<String> ruleSet = new SerialRuleSet(RuleSet.Operator.OR,rule1, rule2, rule3);
